...
buttonTag.onclick = function () {
  if (localStorage.getItem('credEmail') == null || localStorage.getItem('credEmail').length <= 0) {
  ...
  fetch("./js/items.json")
    .then((res) => {
      ...
      res.text().then((data) => {
        ...
        let item = localStorage.getItem('orderId')!= null ?localStorage.getItem('orderId').split(" "):[];
        console.log(counter);
        console.log(item);
